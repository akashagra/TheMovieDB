...
public class Fragmenttab2 extends Fragment {
 ...
 public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
  ...
  MovieDatabase db = MovieDatabase.getInstanceTheatres(getContext());
...
//        courseAsyncTask.setOnDownloadCompleteListener(this);
  ...
  Call<MovieResponse> call = apiInterface.getInTheatresMovies("69a57d4b7c3b085d539f991b8a27ebce");
